            ...
            <div class="tray tray-center">
                ...
                <div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
                    <div class="panel heading-border">
                        <form id="admin-form" name="addForm" action="/addAdmin.do" method="post">
                            <div class="panel-body bg-light">
                                ...
                                <div class="section row">
                                    ...
                                    <div class="section row">
                                        ...
                                        <div class="col-md-6">
                                            <label for="sn" class="field">
                                                <input id="sn" name="sn" class="gui-input" placeholder="名称" type="text"/>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="section row">
                                        ...
                                        <div class="col-md-6">
                                            <label for="psw" class="field">
                                                <input id="psw" name="psw" class="gui-input" placeholder="密码"
                                                       type="text" value=""/>
                                            </label>
                                        </div>
                                    </div>
