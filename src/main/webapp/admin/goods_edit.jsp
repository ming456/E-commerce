            ...
            <div class="tray tray-center">
                ...
                <div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
                    <div class="panel heading-border">
                        <form method="post" action="/updateGoods.do" enctype="multipart/form-data" id="admin-form">
                                ...
                                <div class="section row">
                                    ...
                                    <div class="col-md-5">
                                        <label for="goodsname" class="field prepend-icon">
                                            <input type="text" name="goodsname" id="goodsname" class="gui-input" value="${goods.goodsname}" required>
                                ...
                                <div class="section row">
                                    ...
                                    <div class="col-md-5">
                                        <label for="title" class="field prepend-icon">
                                            <input type="text" name="title" id="title" class="gui-input" value="${goods.title}" required>
                                ...
                                <div class="section row">
                                    ...
                                    <div class="col-md-2">
                                        <label for="price" class="field prepend-icon">
                                            <input type="text" name="price" id="price" class="gui-input" value="${goods.price}" required>
                                    ...
                                    <div class="col-md-2">
                                        <label for="count" class="field prepend-icon">
                                            <input type="number" name="count" id="count" class="gui-input" value="${goods.count}" required>
