...
<script type="text/javascript">
	function submitorder(total){
		if(window.confirm("是否真的提交订单，提交后不可再修改订单信息！")){
			window.location.href="/orderSubmit.do?amount=" + total;
			return true;
		}
		return false;
	}
   ...
   <form action="" method="post">
    <h6>商品列表</h6>
        ...
        <div align="center" style="margin:8px auto;">
       		 <img style="cursor:pointer;"  onclick="submitorder(${total})" src="${pageContext.request.contextPath }/images/before/bnt_subOrder.gif" />
    	</div> 
