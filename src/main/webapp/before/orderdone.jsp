...
<link href="${pageContext.request.contextPath }/css/before/style.css" rel="stylesheet" type="text/css" />
  ...
  <body>
    ...
    <h2 style="text-align:center; height:30px; line-height:30px;">感谢您在本站购物！您的订单已提交成功，
         	请记住您的订单号: <font style="color:red" size='5'>${ordernum}</font></h2><br/>
      <center>
      <form action="/pay.do" method="post" name="payForm">
            	<input type="hidden" name="ordersn" value="${ordersn}"/>
            	<input type="image" src="${pageContext.request.contextPath }/images/before/Chinapay_logo.jpg" onclick="gogo()"/>
      </form>
      </center>
    </div>
    </div>
